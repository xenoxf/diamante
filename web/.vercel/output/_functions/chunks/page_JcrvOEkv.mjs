...
var STRAPI_URL = typeof import.meta !== "undefined" && (Object.assign({
	...
	"SSR": true
}, { _: "/home/juniorxf/.nvm/versions/node/v22.12.0/bin/pnpm" })?.PUBLIC_STRAPI_URL || Object.assign({
	"ASSETS_PREFIX": void 0,
	"BASE_URL": "/",
	"DEV": false,
	"MODE": "production",
	...
	"SITE": "https://diamante-nu.vercel.app",
	"SSR": true
}, { _: "/home/juniorxf/.nvm/versions/node/v22.12.0/bin/pnpm" })?.STRAPI_URL) || "http://localhost:1337";
var STRAPI_TOKEN = typeof import.meta !== "undefined" && Object.assign({
	...
	"SITE": "https://diamante-nu.vercel.app",
	"SSR": true
}, { _: "/home/juniorxf/.nvm/versions/node/v22.12.0/bin/pnpm" })?.STRAPI_API_TOKEN || void 0;
...
var header_module_default = {
	header: "_header_1snxz_3",
	topbar: "_topbar_1snxz_17",
	topbarInner: "_topbarInner_1snxz_23",
	topbarLabel: "_topbarLabel_1snxz_34",
	topbarLinks: "_topbarLinks_1snxz_44",
	mainbar: "_mainbar_1snxz_74",
	mainbarInner: "_mainbarInner_1snxz_78",
	brand: "_brand_1snxz_88",
	logo: "_logo_1snxz_95",
	name: "_name_1snxz_101",
	nav: "_nav_1snxz_120",
	link: "_link_1snxz_128",
	subLink: "_subLink_1snxz_146",
	cta: "_cta_1snxz_147",
	menuButton: "_menuButton_1snxz_148",
	dropdown: "_dropdown_1snxz_160",
	menu: "_menu_1snxz_148",
	actions: "_actions_1snxz_207",
	iconClose: "_iconClose_1snxz_248",
	iconOpen: "_iconOpen_1snxz_256"
};
//#endregion
...
var $$Header = createComponent(async ($$result, $$props, $$slots) => {
	...
	return renderTemplate`${maybeRenderHead($$result)}<header id="site-header"${addAttribute(header_module_default.header, "class")} data-scrolled="false" data-open="false"><div${addAttribute(header_module_default.mainbar, "class")}><div${addAttribute(header_module_default.mainbarInner, "class")}><a href="/"${addAttribute(header_module_default.brand, "class")} aria-label="Institución Educativa El Diamante - inicio"><img${addAttribute(header_module_default.logo, "class")} src="/logo_diamante.png" alt="Escudo de la Institución Educativa El Diamante" width="56" height="56"><span${addAttribute(header_module_default.name, "class")}>Institucion Educativa <br> El Diamante</span></a><nav${addAttribute(header_module_default.nav, "class")} aria-label="Navegación principal">${nav.map((item) => item.children ? renderTemplate`<div${addAttribute(header_module_default.dropdown, "class")}><a${addAttribute(item.href, "href")}${addAttribute(header_module_default.link, "class")} aria-haspopup="true">${item.label}<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="m6 9 6 6 6-6"></path></svg></a><div${addAttribute(header_module_default.menu, "class")} role="menu">${item.children.map((sub) => {
		const isExternal = sub.external || sub.href.startsWith("http");
		return renderTemplate`<a role="menuitem"${addAttribute(header_module_default.subLink, "class")}${addAttribute(sub.href, "href")}${addAttribute(isExternal ? "_blank" : void 0, "target")}${addAttribute(isExternal ? "noopener noreferrer" : void 0, "rel")}>${sub.label}</a>`;
...
var sedesService = {
	...
	async getSedeBySlug(slug) {
		try {
			...
			if (!raw) return sedes.find((s) => s.slug === slug);
