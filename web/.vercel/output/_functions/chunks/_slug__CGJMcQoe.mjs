...
import { d as $$Header, f as $$Layout, h as getStrapiMediaUrls, l as readSource, n as $$Footer, t as $$PageHero } from "./page_JcrvOEkv.mjs";
import { t as $$DataSourceBadge } from "./DataSourceBadge_D8ujJDZl.mjs";
import { t as especialidadesService } from "./especialidades.service_CRoJeAly.mjs";
import { t as setISRHeaders } from "./isr_DLUhkWmb.mjs";
import { t as Masonry } from "./mansory_CKJW7WV2.mjs";
...
async function getStaticPaths() {
	try {
		...
		const { especialidades: fallback } = await import("./especialidades.service_CRoJeAly.mjs").then((n) => n.n);
