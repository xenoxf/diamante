import { N as NoImageMetadata, Y as UnsupportedImageFormat, Z as AstroError, j as MissingSharp } from "./errors-data_CLgk2aMX.mjs";
import { y as detector } from "./path_QTV5kolI.mjs";
import { i as resolveDefaultOutputFormat, n as baseService, r as parseQuality } from "./generic_BxJpFMBu.mjs";
//#region node_modules/.pnpm/astro@7.2.10_@emnapi+core@1.11.1_@emnapi+runtime@1.11.3_@types+node@24.13.3_@vercel+functions@3.9.6/node_modules/astro/dist/assets/services/sharp.js
var sharp;
var qualityTable = {
	low: 25,
	mid: 50,
...
async function loadSharp() {
	let sharpImport;
	try {
		sharpImport = (await import("./dist_d79MLwz3.mjs")).default;
	} catch {
