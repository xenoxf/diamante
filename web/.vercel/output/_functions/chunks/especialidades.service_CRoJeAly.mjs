...
import { c as attachSource, i as mapStrapiEspecialidadToEspecialidad, p as fetchStrapi } from "./page_JcrvOEkv.mjs";
...
var especialidadesService = {
	...
	async getEspecialidadBySlug(slug) {
		try {
			...
			if (!raw) return especialidades.find((e) => e.slug === slug);
