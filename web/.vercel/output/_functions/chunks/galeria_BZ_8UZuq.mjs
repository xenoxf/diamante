...
import { a as mapStrapiGaleriaItemToLegacy, c as attachSource, d as $$Header, f as $$Layout, l as readSource, n as $$Footer, o as mapStrapiGaleriaToGalleryImages, p as fetchStrapi, t as $$PageHero } from "./page_JcrvOEkv.mjs";
...
var $$Galeria = createComponent(async ($$result, $$props, $$slots) => {
	...
	const fotos = await galeriaService.getGaleriaImages(18);
