...
import { d as $$Header, f as $$Layout, m as getStrapiMediaUrl, n as $$Footer, r as sedesService, t as $$PageHero } from "./page_JcrvOEkv.mjs";
...
async function getStaticPaths() {
	try {
		...
		const { sedes: fallback } = await import("./page_JcrvOEkv.mjs").then((n) => n.u);
...
var $$Sede = createComponent(async ($$result, $$props, $$slots) => {
	...
	const mapSrc = sede ? `https://www.google.com/maps?q=${encodeURIComponent(sede.mapQuery)}&output=embed` : "";
