...
var middlewareSecret = "414b5a7f-b73a-443f-949c-1f576f34a68e";
//#endregion
...
var _page1 = () => import("./chunks/_slug__CGJMcQoe.mjs");
var _page2 = () => import("./chunks/index_Crkyv0zf.mjs");
var _page3 = () => import("./chunks/galeria_BZ_8UZuq.mjs");
var _page4 = () => import("./chunks/_slug__DM3K4ol4.mjs");
var _page5 = () => import("./chunks/index_1gmsLMjw.mjs");
var _page6 = () => import("./chunks/_sede__Cy3F9m19.mjs");
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"SSR": true
		}, { _: "/home/juniorxf/.nvm/versions/node/v22.12.0/bin/pnpm" })?.PROD) return {
...
function serializeActionResult(res) {
	if (res.error) {
		if (Object.assign({
			...
			"SITE": "https://diamante-nu.vercel.app",
			"SSR": true
		}, { _: "/home/juniorxf/.nvm/versions/node/v22.12.0/bin/pnpm" })?.DEV) actionResultErrorStack.set(res.error.stack);
		let body2;
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "414b5a7f-b73a-443f-949c-1f576f34a68e") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
